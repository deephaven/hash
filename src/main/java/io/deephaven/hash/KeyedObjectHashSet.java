...
public class KeyedObjectHashSet<K, V> extends KeyedObjectHash<K, V> implements Set<V> {

  /**
   * Creates a new <code>KeyedObjectHashSet</code> instance with the default capacity and load
   * factor.
   */
  public KeyedObjectHashSet(KeyedObjectKey<K, V> keyDef) {
    super(DEFAULT_INITIAL_CAPACITY, DEFAULT_LOAD_FACTOR, keyDef);
  }

  /**
   * Creates a new <code>KeyedObjectHashSet</code> instance with a prime capacity equal to or
   * greater than <tt>initialCapacity</tt> and with the default load factor.
   *
   * @param initialCapacity an <code>int</code> value
   */
  public KeyedObjectHashSet(int initialCapacity, KeyedObjectKey<K, V> keyDef) {
   ...
   */
  public KeyedObjectHashSet(int initialCapacity, float loadFactor, KeyedObjectKey<K, V> keyDef) {
