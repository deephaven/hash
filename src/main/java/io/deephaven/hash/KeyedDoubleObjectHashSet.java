...
public class KeyedDoubleObjectHashSet<K, V> extends KeyedDoubleObjectHash<V> implements Set<V> {

  /**
   * Creates a new <code>KeyedObjectHash</code> instance with the default capacity and load factor.
   */
  public KeyedDoubleObjectHashSet(KeyedDoubleObjectKey<V> keyDef) {
    super(DEFAULT_INITIAL_CAPACITY, DEFAULT_LOAD_FACTOR, keyDef);
  }

  /**
   * Creates a new <code>KeyedDoubleObjectHashSet</code> instance with a prime capacity equal to or
   * greater than <tt>initialCapacity</tt> and with the default load factor.
   *
   * @param initialCapacity an <code>int</code> value
   */
  public KeyedDoubleObjectHashSet(int initialCapacity, KeyedDoubleObjectKey<V> keyDef) {
   ...
   */
  public KeyedDoubleObjectHashSet(
