...
public class KeyedIntObjectHashSet<V> extends KeyedIntObjectHash<V> implements Set<V> {

  /**
   * Creates a new <code>KeyedObjectHash</code> instance with the default capacity and load factor.
   */
  public KeyedIntObjectHashSet(KeyedIntObjectKey<V> keyDef) {
    super(DEFAULT_INITIAL_CAPACITY, DEFAULT_LOAD_FACTOR, keyDef);
  }

  /**
   * Creates a new <code>KeyedIntObjectHashSet</code> instance with a prime capacity equal to or
   * greater than <tt>initialCapacity</tt> and with the default load factor.
   *
   * @param initialCapacity an <code>int</code> value
   */
  public KeyedIntObjectHashSet(int initialCapacity, KeyedIntObjectKey<V> keyDef) {
   ...
   */
  public KeyedIntObjectHashSet(int initialCapacity, float loadFactor, KeyedIntObjectKey<V> keyDef) {
