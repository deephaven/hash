...
public class KeyedLongObjectHashMap<V> extends KeyedLongObjectHash<V>
    implements ConcurrentMap<Long, V>, IndexableMap<Long, V> {

  /**
   * Creates a new <code>KeyedObjectHash</code> instance with the default capacity and load factor.
   */
  public KeyedLongObjectHashMap(KeyedLongObjectKey<V> keyDef) {
    super(DEFAULT_INITIAL_CAPACITY, DEFAULT_LOAD_FACTOR, keyDef);
  }

  /**
   * Creates a new <code>KeyedLongObjectHashMap</code> instance with a prime capacity equal to or
   * greater than <tt>initialCapacity</tt> and with the default load factor.
   *
   * @param initialCapacity an <code>int</code> value
   */
  public KeyedLongObjectHashMap(int initialCapacity, KeyedLongObjectKey<V> keyDef) {
